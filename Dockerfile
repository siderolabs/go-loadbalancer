...
RUN FILES="$(gofumports -l -local github.com/talos-systems/go-loadbalancer .)" && test -z "${FILES}" || (echo -e "Source code is not formatted with 'gofumports -w -local github.com/talos-systems/go-loadbalancer .':\n${FILES}"; exit 1)
